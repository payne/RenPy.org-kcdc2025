...
define config.name = _("Attack on Walmart")
...
define config.main_menu_music = "music/attack-on-titan.mp3"
...
define config.save_directory = "Fight-1569556725"
